...
class FullDeck extends MyCustomElement {
	...
	load(data) {
		...
		$(idPrefix + '_maker').innerHTML = 'Hersteller: '+ i18n('maker', attrs.maker);
		...
		$(idPrefix + '_suits').innerHTML = 'Farbzeichen '+i18n('suits', attrs.suits)+', Index ' + attrs.numIndex + ' mal '+attrs.index;
	}
