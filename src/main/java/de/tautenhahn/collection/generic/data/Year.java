...
public class Year extends AttributeInterpreter
{
  ...
  {
    return createQuestion(object, (text, group) -> new TextQuestion(getName(), text, group, 4, 1));
  }

  private String worstViolation(DescribedObject ctx,
                                List<ReferencedValue> restr,
                                int value,
                                boolean lowerBound)
  {
